...
export default function FirestSection() {
  ...
  return (
    <section className="FirstSection container" onDragStart={Drag}>
      <section
          ...
          return (
            <article key={e.id}>
              <section>
                ...
                <span>
                  {" "}
                  labore ncidunt officiis delectus explicabo necessitatibus
                  impedit, magnam autem et. Saepe totam laudantium error
